...
#define CONFIG_EXTRA_ENV_SETTINGS				\
	...
	"tt=run tftpram\0"					\
	"net_nfs=tftp 80a00000 /tftpboot/gardena/uImage;setenv rootpath /tftpboot/gardena/work/rootfs/yocto-2018-09-21;setenv bootargs console=ttyS0,${baudrate} root=/dev/nfs rw nfsroot=${serverip}:${rootpath},tcp,nfsvers=3 ip=${ipaddr}:${serverip}::${netmask}:${hostname}:eth0:off;bootm 80a00000\0"		\
